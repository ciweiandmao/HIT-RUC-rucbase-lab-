...
RmPageHandle RmFileHandle::fetch_page_handle(int page_no) const {
    ...
    return RmPageHandle(&file_hdr_, this->buffer_pool_manager_->FetchPage({this->fd_, page_no}));
}
...
RmPageHandle RmFileHandle::create_new_page_handle() {
    ...
    Page* neo_page = this->buffer_pool_manager_->NewPage(&page_id);
...
void RmFileHandle::release_page_handle(RmPageHandle &page_handle) {
    ...
    // SYC: AI generated this. I have no clue 'bout this.
